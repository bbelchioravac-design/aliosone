...
A API é ires comprar o motor. Escolhes exactamente o motor que queres — e depois tens de construir o carro à volta dele. Toda a liberdade, todo o trabalho.
...
\- **Escolhes o modelo exacto** — incluindo versões e variantes que a plataforma não mostra.
...
Regras não negociáveis: não se partilha, não se mete em sites duvidosos, não se cola em código que vai para a internet. Já vi acontecer: uma key exposta num projecto publicado, roubada, e a conta esvaziada por estranhos. A regra de segurança do primeiro artigo aplica-se aqui com juros.
...
Aqui declaro interesse: a nossa **ALIOS ONE Chat** (ver acima em Open Source) é exactamente isto —  gratuita, ligas-lhe a key do agregador e falas com o modelo que quiseres. Construímo-la porque precisávamos dela; partilhamo-la porque mais alguém há-de precisar.
...
Um degrau acima na escada técnica: o **CLI** (*command line interface* — a linha de comandos, aquele ecrã preto). Ferramentas como o Claude Code correm o modelo directamente no teu computador, dentro dos teus projectos.
...
Mas há um aviso que ninguém dá: na API não há tecto natural. Pagas o que consomes — e há **formas de consumir muito, depressa**. 
...
Moral: define limites de gasto na conta (todas as APIs deixam) antes de precisares deles e desactiva o carregamento automatico. Ninguém planeia gastar 75€ em 10 minutos numa questão.
